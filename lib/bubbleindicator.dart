...
class BubbleIndicatorPainter extends CustomPainter {
  BubbleIndicatorPainter({
    ...
    this.dy = 25.0,
    this.pageController,
  })  : painter = Paint() // Initialize the painter here
          ..color = CustomTheme.white
          ..style = PaintingStyle.fill,
        super(repaint: pageController);

  final Paint painter; // Now painter is final and initialized in the constructor
  final double dxTarget;
  final double dxEntry;
  final double radius;
  final double dy;

  final PageController? pageController; // Made nullable

  @override
  void paint(Canvas canvas, Size size) {
    // Check if pageController is not null
